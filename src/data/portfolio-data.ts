...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    {
      id: "1",
      title: "Neural-Transliteration Model",
    ...
    },
    {
      ...
      tags: ["Python", "Pandas", "Matplotlib", "SQL", "Financial Modeling", "ETL"],
      liveUrl: "#",
      githubUrl: "#",
      featured: true,
      methodology: "Designed ETL pipeline to track liquidity indicators like DSO and WIP leakage using 10,000+ synthetic records.",
